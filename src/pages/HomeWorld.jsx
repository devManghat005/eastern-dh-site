...
import { useGLTF, useProgress, Text } from "@react-three/drei"; // Text imported
...
function ExploreText({ onClick }) {
  ...
  useFrame(({ clock }) => {
    ...
    if (ref.current) {
      // animate relative to the *original* Y position
  ...
  return (
    <Text
      ref={ref}
      userData={{ baseY: 6 }}   // ← SET YOUR BASE HEIGHT HERE
      position={[-10, 7, 0]}    // ← MOVE IT DOWN HERE
      rotation={[0, 1.56, 0]}
      fontSize={1.5}
      anchorX="center"
      anchorY="middle"
...
/* ==========================================================
   EXPLORE CAMERA CONTROLLER (inside Canvas)
========================================================== */
...
function SceneHDRI({ onReady }) {
  ...
  useEffect(() => {
    ...
    loader.load(
      "/hdr/citrus_orchard_puresky_4k.hdr",
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* EXPLORE SIGN + CAMERA CONTROLLER INSIDE CANVAS */}
        {sceneReady && (
          <>
